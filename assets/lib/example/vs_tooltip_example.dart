...
class _VSTooltipExampleState extends State<VSTooltipExample> {
  ...
  void _showTooltipInfo(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => VSDialog(
        type: VSDialogType.summary,
        title: 'VS Tooltip Information',
        message: '',
        content: Column(
          ...
          children: [
            Text(
              'The VS Tooltip component provides contextual help and information overlays with VS Design System styling.',
            ...
            Text(
              ...
              '• Automatic positioning adjustments to stay in viewport\n'
              '• Rich text content support with line breaks\n'
              '• VS Design System styling integration\n'
              '• Smooth animations and transitions\n'
              '• Proper accessibility support\n'
              '• Touch and hover trigger support\n'
