        ...
        child: Column(
          ...
          children: [
            _buildSection(
              ...
              description:
                  'Comprehensive demonstration of 404 page configurations and real-world usage patterns',
        ...
        _buildPageNotFoundGroup(
          ...
          children: [
            Row(
              children: [
                VSToggle(
                  ...
                  onChanged: (value) =>
                      setState(() => _showCustomActions = value),
            ...
            Container(
              ...
              child: VSPageNotFound(
                customActions: _showCustomActions
                    ? [
                        VSButton(
                          label: 'Custom Action 1',
                          onPressed: () => _showActionDialog(
                            context,
                            'Custom action 1 clicked',
                          ),
                          variant: VSButtonVariant.primary,
                        ),
                        VSButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              padding: EdgeInsets.all(AppSpacing.md),
                              decoration: BoxDecoration(
                                color: AppColors.dangerBg.withValues(
                                  alpha: 0.2,
                                ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            VSButton(
                              label: 'Go Back',
                              onPressed: () =>
                                  _showActionDialog(context, 'Go back clicked'),
                              size: VSButtonSize.small,
                            ...
                            VSButton(
                              label: 'Home',
                              onPressed: () =>
                                  _showActionDialog(context, 'Home clicked'),
                              size: VSButtonSize.small,
                              variant: VSButtonVariant.outlined,
                              width: double.infinity,
                            ),
                  ...
                  Row(
                    ...
                    children: [
                      VSButton(
                        label: 'Go Home',
                        onPressed: () =>
                            _showActionDialog(context, 'Go home clicked'),
                        variant: VSButtonVariant.primary,
                      ),
                      SizedBox(width: AppSpacing.md),
                      VSButton(
                        label: 'Search',
                        onPressed: () =>
                            _showActionDialog(context, 'Search clicked'),
                        variant: VSButtonVariant.outlined,
                      ),
                    ],
                  ),
